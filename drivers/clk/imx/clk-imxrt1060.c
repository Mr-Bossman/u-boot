...
#include <dt-bindings/clock/imxrt1060-clock.h>

#include "clk.h"

static ulong imxrt1060_clk_get_rate(struct clk *clk)
{
	struct clk *c;
	int ret;
...
static ulong imxrt1060_clk_set_rate(struct clk *clk, ulong rate)
{
	struct clk *c;
	int ret;
...
static int __imxrt1060_clk_enable(struct clk *clk, bool enable)
{
	struct clk *c;
	int ret;
...
static int imxrt1060_clk_disable(struct clk *clk)
{
	return __imxrt1060_clk_enable(clk, 0);
}

static int imxrt1060_clk_enable(struct clk *clk)
{
	return __imxrt1060_clk_enable(clk, 1);
}

static int imxrt1060_clk_set_parent(struct clk *clk, struct clk *parent)
{
	struct clk *c, *cp;
	int ret;
...
static struct clk_ops imxrt1060_clk_ops = {
	.set_rate = imxrt1060_clk_set_rate,
	.get_rate = imxrt1060_clk_get_rate,
	.enable = imxrt1060_clk_enable,
	.disable = imxrt1060_clk_disable,
	.set_parent = imxrt1060_clk_set_parent,
};
...
static int imxrt1060_clk_probe(struct udevice *dev)
{
	void *base;
	...
	clk_get_by_id(IMXRT1060_CLK_PLL1_REF_SEL, &clk);
	...
	clk_get_by_id(IMXRT1060_CLK_SEMC_SEL, &clk1);
	clk_get_by_id(IMXRT1060_CLK_SEMC_ALT_SEL, &clk);
	clk_set_parent(clk1, clk);
...
static const struct udevice_id imxrt1060_clk_ids[] = {
	{ .compatible = "fsl,imxrt1060-ccm" },
	{ },
};

U_BOOT_DRIVER(imxrt1060_clk) = {
	.name = "clk_imxrt1060",
	.id = UCLASS_CLK,
	.of_match = imxrt1060_clk_ids,
	.ops = &imxrt1060_clk_ops,
	.probe = imxrt1060_clk_probe,
